...
if strcmp(train_or_classify,'train')
    ...
    claim_condition_query = ['select top 150000 claim_id from claims where claims.' flag ' = ''' start_condition ''' order by claim_id'];
    %claim_condition_query = 'select top 10000 claim_id from claim_scores where model_statistic_id = 400 order by claim_id';
end
