...
%     new_train_mat = spconvert([r new_c_key(c_loc_j) v]);
    ...
    mat_sparse_2_svm_sparse(train_mat(:,2:end),train_file,false,true,train_mat(:,1),1);
    mat_sparse_2_svm_sparse(test_mat(:,2:end),test_file,false,true,test_mat(:,1)),1;     
